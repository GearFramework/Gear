...
interface IoInterface
{
    ...
    /**
     * Открывает файловый дескриптор для операций ввода/вывода
     *
     ...
     * Возвращает кол-во записанных байт
     *
     ...
     * @version 2.0.0
     */
    public function write(int|string|array $data): false|int;
 ...
 * @property DirectoryInterface dir
 * @property string dirname
 * @property string mime
 * @property int size
 * @property string|array content
 * @property DirectoryInterface owner
 * @property int mode
...
interface FileSystemInterface extends IoInterface
{
    ...
    /**
     * Возвращает UNIX-время доступа к элементу файловой системы
     *
     ...
     * @version 2.0.0
     */
    public function atime(?string $format = null): int|string;

    /**
     * Возвращает UNIX-время доступа к элементу файловой системы
     * Геттер к свойству atime
     *
     * @return int
     * @since 2.0.0
     * @version 2.0.0
    ...
    /**
     * Возвращает UNIX-время создания элемента файловой системы
     *
     * @param string|null $format
     * @return int
     * @since 2.0.0
     * @version 2.0.0
     */
    public function ctime(?string $format = null): int|string;

    /**
     * Возвращает UNIX-время создания элемента файловой системы
     * Геттер к свойству ctime
     *
     * @return int
     * @since 2.0.0
     * @version 2.0.0
    ...
    /**
     * Возвращает UNIX-время модификации элемента файловой системы
     *
     * @param string|null $format
     * @return int
     * @since 2.0.0
     * @version 2.0.0
     */
    public function mtime(?string $format = null): int|string;

    /**
     * Возвращает UNIX-время модификации элемента файловой системы
     * Геттер к свойству mtime
     *
     * @return int
     * @since 2.0.0
     * @version 2.0.0
    ...
    /**
     * Возвращает расширение файловой системы
    ...
    /**
     * Возвращает mime-тип файловой системы
     *
     * @return string
     * @since 0.0.1
     * @version 2.0.0
     ...
     * @version 2.0.0
     */
    public function gid(bool $asName = false): false|int|string;
     ...
     * @version 2.0.0
     */
    public function getGid(): false|int;
     ...
     * @version 0.0.1
     */
    public function uid(bool $asName = false): false|int|string;
     ...
     * @version 0.0.1
     */
    public function getUid(): false|int;
     ...
     * @version 2.0.0
     */
    public function size(array|FileSystemOptionsInterface $options = []): int|string;
...
interface FileInterface extends FileSystemInterface
{
     ...
     * @version 2.0.0
     */
    public function put(mixed $data, array|FileSystemOptionsInterface $options = []): bool;
}

/**
 * Базовый интерфейс сокетов
 *
 * @package Gear Framework 2
 * @author Kukushkin Denis
 * @copyright 2022 Kukushkin Denis
 ...
 * @version 2.0.0
 */
interface SocketInterface extends IoInterface
{
