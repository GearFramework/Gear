...
abstract class GFileSystem extends GIo implements FileSystemInterface
{
     ...
     * @version 0.0.2
     */
    abstract public function copy($destination, $options = []): FileSystemInterface;
     ...
     * @version 0.0.2
     */
    abstract public function create($options = []): FileSystemInterface;
     ...
     *
     * @param string|FileInterface|DirectoryInterface $file
     * @return string
     * @since 0.0.1
     * @version 0.0.2
     */
