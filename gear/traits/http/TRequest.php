...
{
    /**
     * @var string $_requestTarget the message's request target
     */
    protected $_requestTarget = null;
    /**
     * @var string $_method the HTTP method of the request
     */
    ...
    /**
     * Set the message's request target.
     *
     * @param string $path
     ...
     * @version 0.0.1
     */
    public function setRequestTarget(string $path): RequestInterface
    {
        $this->_requestTarget = $path;
        return $this;
    }
